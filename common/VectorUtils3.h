...
inline void operator+=(vec3 &a, const vec3 &b) // vec3+=vec3
{
	a = a + b;
}
...
inline void operator*=(vec3 &a, const float &b) // vec3*=scalar
{
	a = a * b;
}
...
inline void operator+=(vec4 &a, const vec4 &b) // vec4+=vec4
{
	a = a + b;
}
...
inline void operator*=(vec4 &a, const float &b) // vec4 *= scalar
{
	a = a * b;
}
